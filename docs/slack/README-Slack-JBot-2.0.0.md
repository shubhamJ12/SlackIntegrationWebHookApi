...
All the code for your bot goes in [SlackBot](/src/main/java/me/shubham/jbot/slackbot/SlackBot.java) class which
extends [Bot](/src/main/java/me/shubham/jbot/slackbot/core/Bot.java) from the core package. You can have as many
bots as you want, just make the class extend [Bot](/src/main/java/me/shubham/jbot/slackbot/core/Bot.java) class
...
The [core](src/main/java/me/shubham/jbot/slackbot/core) package contains all of JBot code. You can create
packages outside `core` package and put your custom code there. To make a 
* __Slack Bot__ &rArr; Extend [Bot](/src/main/java/me/shubham/jbot/slackbot/core/Bot.java) class.  
* __Slash Command Handler__ &rArr; Annotate your [class](/src/main/java/me/shubham/jbot/slackbot/SlackSlashCommand.java)
  with Spring's `@Controller` and have a [method](/src/main/java/me/shubham/jbot/slackbot/SlackSlashCommand.java#onReceiveSlashCommand)
...
* __Slack Incoming Webhook__ &rArr; Just make a `POST` call with 
  [RichMessage](/src/main/java/me/shubham/jbot/slackbot/core/models/RichMessage.java) whenever you want to update 
  your Slack users about something.
* __Slack Outgoing Webhook__ &rArr; Same as Slash Command Handler.

#### Receiving Messages

For __Bots__, you receive a message as [Event](/src/main/java/me/shubham/jbot/slackbot/core/models/Event.java). For
...
What you're doing here is annotating a method with [@Controller](/src/main/java/me/shubham/jbot/slackbot/core/Controller.java)
...
You can also add regular expressions to your [@Controller](/src/main/java/me/shubham/jbot/slackbot/core/Controller.java)
annotation like:
...
In __Incoming Webhooks__, your [application](/src/main/java/me/shubham/jbot/slackbot/SlackWebhooks.java) `POST` 
data and do not receive any data apart from the acknowledgement for your sent data. You send data
as [RichMessage](/src/main/java/me/shubham/jbot/slackbot/core/models/RichMessage.java) to Slack Webhook URL.
...
In __Bots__, you can use the `reply()` method defined in [Bot](/src/main/java/me/shubham/jbot/slackbot/core/Bot.java)
class to send messages to Slack. You just need to set the text you want to send in 
[Message](/src/main/java/me/shubham/jbot/slackbot/core/models/Message.java) and everything else will be taken care 
...
[RichMessage](/src/main/java/me/shubham/jbot/slackbot/core/models/RichMessage.java). Just keep in mind to encode it
...
__Points to Note:__ 
* [Event](/src/main/java/me/shubham/jbot/slackbot/core/models/Event.java), 
[Message](/src/main/java/me/shubham/jbot/slackbot/core/models/Message.java) and 
[RichMessage](/src/main/java/me/shubham/jbot/slackbot/core/models/RichMessage.java) are generic models. Not all the 
...
[Message](/src/main/java/me/shubham/jbot/slackbot/core/models/Message.java) object.
...
[next](/src/main/java/me/shubham/jbot/slackbot/core/Controller.java#next) attribute of 
[Controller](/src/main/java/me/shubham/jbot/slackbot/core/Controller.java) annotation.
...
[core](/src/main/java/me/shubham/jbot/slackbot/core) package) or you can include it as a maven/gradle dependency.
...
```groovy
dependencies {
    compile("me.shubham.jbot:jbot:2.0.0")
}
```
