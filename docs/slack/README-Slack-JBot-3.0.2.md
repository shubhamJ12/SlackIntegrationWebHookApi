# JBot [![Build Status](https://travis-ci.org/shubham/jbot.svg?branch=master)](https://travis-ci.org/shubham/jbot) [![Javadocs](http://www.javadoc.io/badge/me.shubham.jbot/jbot.svg?color=orange)](http://www.javadoc.io/doc/me.shubham.jbot/jbot) [![Gitter](https://badges.gitter.im/shubham/jbot.svg)](https://gitter.im/shubham/jbot?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) [![Bountysource](https://api.bountysource.com/badge/team?team_id=160604)](https://www.bountysource.com/teams/jbot) [![Gratipay Team](https://img.shields.io/gratipay/team/shields.svg?maxAge=2592000)](https://gratipay.com/JBot/) [![MIT license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/shubham/jbot/master/LICENSE)
...
1. Clone this project `$ git clone git@github.com:shubham/jbot.git` and `$ cd jbot`.  
...
**Still not satisfied?** Open an [issue on Github](https://github.com/shubham/jbot/issues) and we can chat.
...
extends [Bot](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Bot.java) from the core package. You can have as many
bots as you want, just make the class extend [Bot](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Bot.java) class
...
* __Slack Bot__ &rArr; Extend [Bot](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Bot.java) class.  
* __Slash Command Handler__ &rArr; Annotate your [class](/jbot-example/src/main/java/example/jbot/slack/SlackSlashCommand.java)
  ...
  [sample](/src/main/java/me/shubham/jbot/slackbot/SlackSlashCommand.java).  
* __Slack Incoming Webhook__ &rArr; Just make a `POST` call with 
  [RichMessage](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/RichMessage.java) whenever you want to update 
  your Slack users about something.
* __Slack Outgoing Webhook__ &rArr; Same as Slash Command Handler.

#### Receiving Messages

For __Bots__, you receive a message as [Event](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/Event.java). For
...
What you're doing here is annotating a method with [@Controller](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Controller.java)
...
You can also add regular expressions to your [@Controller](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Controller.java)
annotation like:
...
as [RichMessage](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/RichMessage.java) to Slack Webhook URL.
...
In __Bots__, you can use the `reply()` method defined in [Bot](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Bot.java)
class to send messages to Slack. You just need to set the text you want to send in 
[Message](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/Message.java) and everything else will be taken care 
...
[RichMessage](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/RichMessage.java). Just keep in mind to encode it
...
__Points to Note:__ 
* [Event](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/Event.java), 
[Message](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/Message.java) and 
[RichMessage](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/RichMessage.java) are generic models. Not all the 
...
[Message](/jbot-core/src/main/java/me/shubham/jbot/core/slack/models/Message.java) object.
...
[next](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Controller.java#next) attribute of 
[Controller](/jbot-core/src/main/java/me/shubham/jbot/core/slack/Controller.java) annotation.
...
```groovy
dependencies {
    compile("me.shubham.jbot:jbot:3.0.2")
}
```

__NOTE:__ When you include jbot as a dependency please make sure to include `me.shubham.jbot` package for auto-scan.
...
* [README-Slack-JBot-3.0.2](/readme/README-Slack-JBot-3.0.2.md)
* [README-Slack-JBot-2.0.0](/readme/README-Slack-JBot-2.0.0.md)
* [README-Slack-BotKit-1.1.0](/readme/README-Slack-BotKit-1.1.0.md)

### Contributions

If you would like like to contribute, raise an [issue on Github](https://github.com/shubham/jbot/issues) and I would
